...
//                }
                ...
                String confirm_pwd = etCofirmPassword.getText().toString().trim();
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            ...
                            showLongToast(getResources().getString(R.string.Registered_successfully));
